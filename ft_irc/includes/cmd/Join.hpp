...
class Join : public Command
{
  public:
	...
	{
		_name = "join";
		_description = "joins the user to the channel if it exists or generates a new"
		               "canal";
		_usage = "join <canal>{,<canal>} [<key>{,<key>}]";
		_example[0] = "join #canal1 key1";
		_example[1] = "join #canal1,#canal2 key1,key2";
